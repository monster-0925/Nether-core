// Copyright (c) 2018-present The Comedian Core developers
...
//! Entry point for ComedianApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ComedianApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ComedianGUI tests.
void AppTests::guiTests(ComedianGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ComedianGUI::consoleShown, this, &AppTests::consoleTests);
