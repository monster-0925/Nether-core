// Copyright (c) 2011-present The Comedian Core developers
...
const std::string ComedianGUI::DEFAULT_UIPLATFORM =
...
ComedianGUI::ComedianGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &ComedianGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &ComedianGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &ComedianGUI::showModalOverlay);
...
void ComedianGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Comedian address"));
    ...
    connect(overviewAction, &QAction::triggered, this, &ComedianGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &ComedianGUI::gotoReceiveCoinsPage);
    connect(historyAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(historyAction, &QAction::triggered, this, &ComedianGUI::gotoHistoryPage);
#endif // ENABLE_WALLET
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Comedian addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Comedian addresses"));
    m_load_psbt_action = new QAction(tr("&Load PSBT from file…"), this);
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Comedian Transaction"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load Partially Signed Comedian Transaction from clipboard"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Comedian command-line options").arg(CLIENT_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &ComedianGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &ComedianGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &ComedianGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &ComedianGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &ComedianGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &ComedianGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &ComedianGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &ComedianGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &ComedianGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &ComedianGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &ComedianGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &ComedianGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &ComedianGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &ComedianGUI::showDebugWindow);
}

void ComedianGUI::createMenuBar()
{
    appMenuBar = menuBar();
...
void ComedianGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &ComedianGUI::setCurrentWalletBySelectorIndex);
...
void ComedianGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &ComedianGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &ComedianGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &ComedianGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &ComedianGUI::showProgress);
...
#ifdef ENABLE_WALLET
void ComedianGUI::enableHistoryAction(bool privacy)
{
...
void ComedianGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &ComedianGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &ComedianGUI::removeWallet);
...
WalletController* ComedianGUI::getWalletController()
{
    return m_wallet_controller;
}

void ComedianGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &ComedianGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &ComedianGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &ComedianGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &ComedianGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &ComedianGUI::incomingTransaction);
    connect(this, &ComedianGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
    wallet_view->setPrivacy(isPrivacyModeActivated());
    const QString display_name = walletModel->getDisplayName();
    m_wallet_selector->addItem(display_name, QVariant::fromValue(walletModel));
}

void ComedianGUI::removeWallet(WalletModel* walletModel)
{
...
void ComedianGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void ComedianGUI::setCurrentWalletBySelectorIndex(int index)
{
    WalletModel* wallet_model = m_wallet_selector->itemData(index).value<WalletModel*>();
    if (wallet_model) setCurrentWallet(wallet_model);
}

void ComedianGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void ComedianGUI::setWalletActionsEnabled(bool enabled)
{
...
void ComedianGUI::createTrayIcon()
{
...
void ComedianGUI::createTrayIconMenu()
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
#endif // Q_OS_MACOS
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &ComedianGUI::toggleHidden);
...
void ComedianGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void ComedianGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void ComedianGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void ComedianGUI::showDebugWindowActivateConsole()
{
    rpcConsole->setTabFocus(RPCConsole::TabTypes::CONSOLE);
    showDebugWindow();
}

void ComedianGUI::showHelpMessageClicked()
{
    GUIUtil::bringToFront(helpMessageDialog);
}

#ifdef ENABLE_WALLET
void ComedianGUI::openClicked()
{
...
void ComedianGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void ComedianGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void ComedianGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void ComedianGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void ComedianGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void ComedianGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void ComedianGUI::gotoLoadPSBT(bool from_clipboard)
{
    if (walletFrame) walletFrame->gotoLoadPSBT(from_clipboard);
}
#endif // ENABLE_WALLET

void ComedianGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Comedian network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void ComedianGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void ComedianGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void ComedianGUI::updateHeadersSyncProgressLabel()
{
...
void ComedianGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void ComedianGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &ComedianGUI::quitRequested);
...
void ComedianGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void ComedianGUI::createWallet()
{
#ifdef ENABLE_WALLET
    auto activity = new CreateWalletActivity(getWalletController(), this);
    connect(activity, &CreateWalletActivity::created, this, &ComedianGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void ComedianGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void ComedianGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &ComedianGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &ComedianGUI::show);
                e->ignore();
            }
        }
    }
...
void ComedianGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void ComedianGUI::showEvent(QShowEvent *event)
{
...
#ifdef ENABLE_WALLET
void ComedianGUI::incomingTransaction(const QString& date, ComedianUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
    // On new transaction, make an info balloon
    QString msg = tr("Date: %1\n").arg(date) +
                  tr("Amount: %1\n").arg(ComedianUnits::formatWithUnit(unit, amount, true));
...
void ComedianGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void ComedianGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool ComedianGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool ComedianGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void ComedianGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void ComedianGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void ComedianGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void ComedianGUI::updateProxyIcon()
{
    std::string ip_port;
...
void ComedianGUI::updateWindowTitle()
{
...
void ComedianGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void ComedianGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void ComedianGUI::detectShutdown()
{
...
void ComedianGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void ComedianGUI::showModalOverlay()
{
    if (modalOverlay && (progressBar->isVisible() || modalOverlay->isLayerVisible()))
        modalOverlay->toggleVisibility();
}

static bool ThreadSafeMessageBox(ComedianGUI* gui, const bilingual_str& message, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = ComedianGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
void ComedianGUI::subscribeToCoreSignals()
{
...
void ComedianGUI::unsubscribeFromCoreSignals()
{
...
bool ComedianGUI::isPrivacyModeActivated() const
{
    ...
    : m_platform_style{platformStyle}
{
    ...
    QList<ComedianUnit> units = ComedianUnits::availableUnits();
    int max_width = 0;
    const QFontMetrics fm(font());
    for (const ComedianUnit unit : units) {
        max_width = qMax(max_width, GUIUtil::TextWidth(fm, ComedianUnits::longName(unit)));
    }
...
{
    menu = new QMenu(this);
    for (const ComedianUnit u : ComedianUnits::availableUnits()) {
        menu->addAction(ComedianUnits::longName(u))->setData(QVariant::fromValue(u));
    }
...
void UnitDisplayStatusBarControl::updateDisplayUnit(ComedianUnit newUnits)
{
    setText(ComedianUnits::longName(newUnits));
}
