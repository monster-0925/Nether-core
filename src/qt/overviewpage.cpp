...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = ComedianUnits::formatWithUnit(unit, amount, true, ComedianUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
    ...
    ComedianUnit unit{ComedianUnit::BTC};
...
{
    ComedianUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(ComedianUnits::formatWithPrivacy(unit, balances.balance, ComedianUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(ComedianUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, ComedianUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(ComedianUnits::formatWithPrivacy(unit, balances.immature_balance, ComedianUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(ComedianUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, ComedianUnits::SeparatorStyle::ALWAYS, m_privacy));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("BAN")
    updateDisplayUnit();
}
