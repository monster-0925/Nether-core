      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->openComedianConfButton->setToolTip(ui->openComedianConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new ComedianUnits(this));
...
void OptionsDialog::on_openComedianConfButton_clicked()
{
