...
public:
    CComedianParams() {
        ...
        consensus.nPowTargetSpacing = 300; // 5 min blocks

        genesis = CreateGenesisBlock(
            1777971308,   // timestamp
            74759,       // nonce
            0x1d00ffff,
            1,
            50 * COIN
        ...
        consensus.hashGenesisBlock = uint256{"b726990c1c62d2898faf0401f45d4736f63b1698908eb73db88706982afec6af"};
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1777971308, 74759, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = uint256{"b726990c1c62d2898faf0401f45d4736f63b1698908eb73db88706982afec6af"};
        
        std::cout << "GEN HASH: " << genesis.GetHash().ToString() << std::endl;
        ...
        assert(consensus.hashGenesisBlock == uint256{"b726990c1c62d2898faf0401f45d4736f63b1698908eb73db88706982afec6af"});
        assert(genesis.hashMerkleRoot == uint256{"7327842e81adfa95e230f15339dd149e454268fac4bef68ef06de1b2b59810d1"});
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1777971308, 74759, 0x1e0fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = uint256{"b726990c1c62d2898faf0401f45d4736f63b1698908eb73db88706982afec6af"};
        //assert(consensus.hashGenesisBlock == uint256{"b726990c1c62d2898faf0401f45d4736f63b1698908eb73db88706982afec6af"});
        //assert(genesis.hashMerkleRoot == uint256{"7327842e81adfa95e230f15339dd149e454268fac4bef68ef06de1b2b59810d1"});
...
std::unique_ptr<const CChainParams> CChainParams::Comedian()
{
...
std::optional<ChainType> GetNetworkForMagic(const MessageStartChars& message)
{
    ...
    } else if (std::ranges::equal(message, CChainParams::Comedian()->MessageStart())) {
    return ChainType::COMEDIAN;
    }
    return std::nullopt;
}
